...
${OBJECTDIR}/APICommonCode/QTAccessFile.o: APICommonCode/QTAccessFile.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/APICommonCode/QTAccessFile.o APICommonCode/QTAccessFile.cpp

${OBJECTDIR}/APICommonCode/QTSSModuleUtils.o: APICommonCode/QTSSModuleUtils.cpp 
	${MKDIR} -p ${OBJECTDIR}/APICommonCode
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/APICommonCode/QTSSModuleUtils.o APICommonCode/QTSSModuleUtils.cpp
...
${OBJECTDIR}/PrefsSourceLib/FilePrefsSource.o: PrefsSourceLib/FilePrefsSource.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrefsSourceLib/FilePrefsSource.o PrefsSourceLib/FilePrefsSource.cpp

${OBJECTDIR}/PrefsSourceLib/XMLParser.o: PrefsSourceLib/XMLParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/PrefsSourceLib
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrefsSourceLib/XMLParser.o PrefsSourceLib/XMLParser.cpp
...
${OBJECTDIR}/Server.tproj/GenerateXMLPrefs.o: Server.tproj/GenerateXMLPrefs.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/GenerateXMLPrefs.o Server.tproj/GenerateXMLPrefs.cpp

${OBJECTDIR}/Server.tproj/QTSSCallbacks.o: Server.tproj/QTSSCallbacks.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSSCallbacks.o Server.tproj/QTSSCallbacks.cpp

${OBJECTDIR}/Server.tproj/QTSSDataConverter.o: Server.tproj/QTSSDataConverter.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSSDataConverter.o Server.tproj/QTSSDataConverter.cpp

${OBJECTDIR}/Server.tproj/QTSSDictionary.o: Server.tproj/QTSSDictionary.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSSDictionary.o Server.tproj/QTSSDictionary.cpp

${OBJECTDIR}/Server.tproj/QTSSErrorLogModule.o: Server.tproj/QTSSErrorLogModule.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSSErrorLogModule.o Server.tproj/QTSSErrorLogModule.cpp

${OBJECTDIR}/Server.tproj/QTSSExpirationDate.o: Server.tproj/QTSSExpirationDate.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSSExpirationDate.o Server.tproj/QTSSExpirationDate.cpp

${OBJECTDIR}/Server.tproj/QTSSFile.o: Server.tproj/QTSSFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSSFile.o Server.tproj/QTSSFile.cpp

${OBJECTDIR}/Server.tproj/QTSSMessages.o: Server.tproj/QTSSMessages.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSSMessages.o Server.tproj/QTSSMessages.cpp

${OBJECTDIR}/Server.tproj/QTSSModule.o: Server.tproj/QTSSModule.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSSModule.o Server.tproj/QTSSModule.cpp

${OBJECTDIR}/Server.tproj/QTSSPrefs.o: Server.tproj/QTSSPrefs.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSSPrefs.o Server.tproj/QTSSPrefs.cpp

${OBJECTDIR}/Server.tproj/QTSSSocket.o: Server.tproj/QTSSSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSSSocket.o Server.tproj/QTSSSocket.cpp

${OBJECTDIR}/Server.tproj/QTSServer.o: Server.tproj/QTSServer.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSServer.o Server.tproj/QTSServer.cpp

${OBJECTDIR}/Server.tproj/QTSServerInterface.o: Server.tproj/QTSServerInterface.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSServerInterface.o Server.tproj/QTSServerInterface.cpp

${OBJECTDIR}/Server.tproj/QTSServerPrefs.o: Server.tproj/QTSServerPrefs.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/QTSServerPrefs.o Server.tproj/QTSServerPrefs.cpp

${OBJECTDIR}/Server.tproj/RunServer.o: Server.tproj/RunServer.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/RunServer.o Server.tproj/RunServer.cpp

${OBJECTDIR}/Server.tproj/main.o: Server.tproj/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/Server.tproj
	${RM} "$@.d"
	$(COMPILE.cc) -g -DHI_OS_LINUX -IAPICommonCode -IAPIStubLib -ICommonUtilitiesLib -IHTTPUtilitiesLib -IInclude -IServer.tproj -IPrefsSourceLib -I../../EasyDarwin/CMS/Include/libEasyCMS -I. -include PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.tproj/main.o Server.tproj/main.cpp
